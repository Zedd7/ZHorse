...
public class MessageManager {	
	...
	private void initColors() {
		...
		String[] aqua = {"<b>", "§b", "<aqua>", "aqua"};
		String[] black = {"<0>", "§0", "<black>", "black"};
		String[] blue = {"<9>", "§9", "<blue>", "blue"};
		String[] bold = {"<l>", "§l", "<bold>", "bold"};
		String[] dark_aqua = {"<3>", "§3", "<dark_aqua>", "<darkaqua>", "dark_aqua", "darkaqua"};
		String[] dark_blue = {"<1>", "§1", "<dark_blue>", "<darkblue>", "dark_blue", "darkblue"};
		String[] dark_gray = {"<8>", "§8", "<dark_gray>", "<darkgray>", "dark_gray", "darkgray"};
		String[] dark_green = {"<2>", "§2", "<dark_green>", "<darkgreen>", "dark_green", "darkgreen"};
		String[] dark_purple = {"<5>", "§5", "<dark_purple>", "<darkpurple>", "dark_purple", "darkpurple"};
		String[] dark_red = {"<4>", "§4", "<dark_red>", "<darkred>", "dark_red", "darkred"};
		String[] gold = {"<6>", "§6", "<gold>", "gold"};
		String[] gray = {"<7>", "§7", "<gray>", "gray"};
		String[] green = {"<a>", "§a", "<green>", "green"};
		String[] italic = {"<o>", "§o", "<italic>", "italic"};
		String[] light_purple = {"<d>", "§d", "<light_purple>", "<lightpurple>", "light_purple", "lightpurple"};
		String[] magic = {"<k>", "§k", "<magic>", "magic"};
		String[] red = {"<c>", "§c", "<red>", "red"};
		String[] reset = {"<r>", "§r", "<reset>", "reset"};
		String[] strikethrough = {"<m>", "§m", "<strikethrough>", "strikethrough"};
		String[] underline = {"<n>", "§n", "<underline>", "underline"};
		String[] white = {"<f>", "§f", "<white>", "white"};
		String[] yellow = {"<e>", "§e", "<yellow>", "yellow"};
